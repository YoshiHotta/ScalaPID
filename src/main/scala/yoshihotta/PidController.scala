...
/** Small, easy to use PID implementation with advanced controller capability.
  ...
  * }
  *
  * This code was first written in [Java by Dan Sheadel](https://github.com/tekdemo/MiniPID-Java),
  * and translated into Scala by Yoshi Hotta.
  *
  * @see http://brettbeauregard.com/blog/2011/04/improving-the-beginners-pid-direction/improving-the-beginners-pid-introduction
  */

class PidController {
  private val P = 0.0 //todo: 意味を書く
  private val I = 0.0
  private val D = 0.0
  private val F = 0.0


  private val maxIOutput = 0.0
  private val maxError = 0.0
  private val errorSum = 0.0

  private val maxOutput = 0.0
  private val minOutput = 0.0
  private val setPoint = 0.0

  private val lastActual = 0.0

  private val firstRun = true
  private val revered = true

  private val outputRampRate = true
  private val lastOutput = true

  private val outputFilter = 0.0
  private val setpointRange = 0.0
